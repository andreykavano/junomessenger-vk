...
var cmds = [
    ...
    },
    {
        regexp:/^\/(stable)/i,
        f:function(params,msg){
            msg.send("Стабильная версия приложения.", {attachment:"doc296240340_445956769"});
        },
        command:"/stable",
    ...
    },
     {
        regexp:/^\/(beta)/i,
        f:function(params,msg){
            msg.send("Внимание! Это экспериментальная версия! Баги и вылеты здесь возможны.", {attachment:"doc296240340_445956801"});
        },
        command:"/beta",
